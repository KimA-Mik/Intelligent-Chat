...
//    }
    ...
    @Test
    fun utf8MultipointFromVocabularyTest() {
    ...
    @Test
    fun utf8MultipointNotInVocabularyTest() {
    ...
    @Test
    fun utf8MultipointNotInVocabularyWithDifferentLengthTest() {
    ...
    @Test
    fun utf8MultipointNotInVocabularyWithDifferentLength2Test() {
        assertArrayEquals(
